...
async def render_3d_skin_random(
    user: str = "",
):
    # A wrapper for render_3d_skin that generates random poses

    im = await render_3d_skin(
        user=user,
        vr = np.random.randint(-25, 25, 1),
        hr = np.random.randint(-35, 35, 1),
        hrh = np.random.randint(0, 360, 1),
        vrll = np.random.randint(-90, 90, 1),
        vrrl = np.random.randint(-90, 90, 1),
        vrla = np.random.randint(0, 360, 1),
        vrra = np.random.randint(0, 360, 1),
        ratio = 12,
    )
